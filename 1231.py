...
w_omega = tf.Variable(tf.random_normal([12,1], stddev=0.1))
b_omega = tf.Variable(tf.random_normal([1], stddev=0.1))
u_omega = tf.Variable(tf.random_normal([1], stddev=0.1))
