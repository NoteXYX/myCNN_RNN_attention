...
class myModel(object):
    ...
    def __init__(self,
        ...
        for s_num in range(self.batch_size):
            cur_wordidx_list = self.input_word_idx
        ...
        # word_emb_inputs = tf.nn.dropout(word_emb_inputs, rate=1 - self.keep_prob, name='word_emb_inputs')
